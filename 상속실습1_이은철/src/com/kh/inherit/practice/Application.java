...
public class Application {
	...
	public static void main(String[] args) {
		/*
		 * 3명의 학생정보를 기록할 수 있게 객체 배열을 할당 데이터를 참고하여 3명의 학생 객체 생성 반복문을 통해 출력
		 */
		// 배열 선언 : 같은 타입의 데이터를 여러개 보관
		// 배연선언 : 타입[] 변수명 - new 타입[길이]
		...
		sArry[0] = s1; // 방법 1
		sArry[1] = new Student("김말똥", 21, 187.3, 80.0, 2, "경영학과"); // 방법2
		sArry[2] = new Student("강개순", 23, 167.0, 45.0, 4, "정보통신공학과");

		for (Student s : sArry) { // 배열의 타입을 넣어야 됨
			System.out.println(s.information());
		}

		/*
		 * 최대 10명의 사원 정보를 기록할 객체 배열 생성 키보드로 사원 정보를 입력 받도록 구현 employee타입을 담을수 있는 10개의 방이
		 * 생성되고
		 * 
		 */
		...
		while (true) {
			...
			for (Employee e : empArry) {
				...
				// e. <-- 주소접근연산자인 .을 이용할 경우
				// null은 주소를 가지고 있지 않으므로 오류가 발생한다.
				if (e == null) {
					break;
				}
